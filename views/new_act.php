...
<body>
    ...
    <div class="statistique-card shadow-lg">
        <div class="statistique-header d-flex align-items-center justify-content-center mb-4">
            <i class="fas fa-chart-bar fa-2x me-2 text-primary"></i>
            <h3 class="m-0 text-dark">Statistiques des Activités</h3>
        </div>
        <div class="chart-container">
            <canvas id="statistiquesChart" height="50"></canvas>
        </div>
    </div>
</div>
...
<!-- Canvas pour afficher le graphique -->
    <script>
       ...
       //json_encode() convertit les résultats SQL en tableau JavaScript 
...
new Chart(ctx, {
  ...
  y: {
    ...
    suggestedMax: Math.max(...data) + 1 // ajoute une marge de 1 au max
  },
  x: {
    ticks: {
      autoSkip: false

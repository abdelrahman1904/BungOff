...
<header>
    ...
    <nav>
        <ul>
            ...
            <a href="mes_reservations.php" class="btn-mes-reservations">Voir mes réservations</a>
    </div>
...
<div class="video-container">
    <img class="full-width-image" src="chemin/vers/bungalow-tunisie.jpg" alt="Bungalow en Tunisie">
</div>
<div class="bungalow-background"></div>
        ...
        <?php foreach ($bungalows as $bungalow): ?>
            <div class="bungalow-card">
                ...
                <div class="bungalow-info">
                    ...
                    <a href="reservationFront.php?id_bungalow=<?php echo $bungalow['IDB']; ?>" class="btn btn-primary">Réserver maintenant</a>

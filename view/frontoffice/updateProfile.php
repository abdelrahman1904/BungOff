...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image = $_FILES['image'];
    $is2f = isset($_POST['is2f']) ? 1 : 0; // Check if 2FA is enabled
    ...
    $user = new userlist($fullname, $username, $email, $pass, $age, $imagePath,"user", $is2f, null);
    ...
    header("Location: ../frontoffice/homePage.php");
    exit();
}
?>

...
require_once '../../../vendor1/PHPMailer-master/src/Exception.php';
require_once '../../../vendor1/PHPMailer-master/src/PHPMailer.php';
require_once '../../../vendor1/PHPMailer-master/src/SMTP.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 if (empty($errors)) {
    // Récupérer l'id_user depuis la session AVANT la création de l'objet réservation
    $id_user = $_SESSION['user']['id'] ?? null;


    $reservation = new Reservation($id_bungalow, $date_arrive, $date_depart, $nbp, $prix_total, $id_user);

...
//Vérifie si la réponse contient des données valides (code de réponse 200). Si non, le script s'arrête avec un message d'erreur.
...
$current = $data['list'][0];
//Récupération du fuseau horaire de la ville 
...
<head>
    ...
    <a href="bungalow_front.php" class="back-button">
    ...
    top: 20px;
    left: 20px;
    background: rgba(53, 43, 195, 0.15);
    color: white;
    padding: 8px 12px;
    border-radius: 8px;

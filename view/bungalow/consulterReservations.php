...
require_once '../../config.php'; // Importation du contrôleur pour récupérer les bungalows
$reservationC = new ReservationC();
  // Création de l'objet BungalowC
            ...
            <tbody>
                <?php if (!empty($listeReservations)) {
                    foreach ($listeReservations as $reservation) {
                        ...
                        echo '<tr>';
                        echo '<td>' . htmlspecialchars($reservation['nom_bungalow']) . '</td>';
                       ...
                       echo '<td><img src="frontoffice/image_video1/' . htmlspecialchars($reservation['image_bungalow']) . '" alt="Image Bungalow" width="80" height="60"></td>';
                        echo '<td>

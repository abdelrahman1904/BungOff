...
<body>
    ...
    <div class="content">
        <a href="newback_bung.html" class="back-link">
            <i class="fas fa-arrow-left"></i> Retour àu Dashboard
        </a>
    ...
    <script>
        ...
        const regexNom = /^[A-Za-zÀ-ÖØ-öø-ÿ\s'-]+$/; // Lettres + accents + espaces + apostrophes

        if (nom === '') {
            alert('Le nom est requis.');
            valid = false;
        } else if (!regexNom.test(nom)) {
            alert('Le nom ne doit contenir que des lettres (pas de chiffres ni symboles).');
            valid = false;
        }

        // Les autres validations...

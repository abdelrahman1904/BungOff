...
$avis = $avisController->getAvis($idUtilisateur);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
    try {
        ...
        error_log("Form data for update: " . print_r($data, true));

        $avisController->updateAvis($data);
...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="index.php"><i class="fas fa-comments"></i> Avis</a></li>
        </ul>
    </nav>
...
<div class="container mt-5">
    ...
    <form id="avisForm" method="POST" action="">
        <input type="hidden" name="IDUtilisateur" value="<?= htmlspecialchars($avis['IDUtilisateur']) ?>">
        
        <div class="form-group">
            <label for="Nom">Nom:</label>
            <input type="text" id="Nom" name="Nom" value="<?= htmlspecialchars($avis['Nom']) ?>" required>
        </div>
        
        <div class="form-group">
            <label for="LieuDuBungalow">Lieu du Bungalow:</label>
            <input type="text" id="LieuDuBungalow" name="LieuDuBungalow" value="<?= htmlspecialchars($avis['LieuDuBungalow']) ?>" required>
        </div>
        
        <div class="form-group">
            <label for="ActivitéUtilisée">Activité Utilisée:</label>
            <input type="text" id="ActivitéUtilisée" name="ActivitéUtilisée" value="<?= htmlspecialchars($avis['ActivitéUtilisée']) ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="Commentaire" name="Commentaire" required><?= htmlspecialchars($avis['Commentaire']) ?></textarea>
        </div>
        
        <button type="submit" name="update" class="btn btn-edit">Modifier Avis</button>
    </form>
</div>

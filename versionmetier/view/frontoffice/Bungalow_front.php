...
if (isset($_GET['refresh'])) {
    unset($_GET['search']); // Supprime le paramètre de recherche
    header("Location: ".strtok($_SERVER['REQUEST_URI'], '?')); // Redirige sans paramètres
    exit();
}
    ...
    // Lier les paramètres seulement s'ils existent
...
.search-buttons {
    position: absolute;
    right: -60px; /* Ajustez cette valeur selon besoin */
    top: 50%;
...
.search-container.active .search-buttons {
    opacity: 1;
    visibility: visible;
    right: -80px; /* Ajustez cette valeur selon besoin */
}
...
.search-container.active .search-refresh {
...
<header>
    ...
    <nav>
        <ul>
            ...
            <a href="mes_reservations.php" class="cta-button mes-reservations"> mes réservations</a>
    </div>
    ...
    <form method="GET" action="" class="search-form">
        <input type="text" name="search" placeholder="Rechercher bungalow..." class="search-input" style="display: none;">
        <div class="search-buttons">
            <button type="submit" class="search-submit" style="display: none;">
                <i class="fas fa-check"></i>
            </button>
            <button type="button" class="search-refresh" style="display: none;">
...
<div class="image-container">
    <img class="full-width-image" src="images/bungalow4.jpg" alt="Bungalow en Tunisie">
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        if (!searchContainer.contains(e.target) && !e.target.classList.contains('search-toggle')) {

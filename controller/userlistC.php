...
class userlistC   {
    ...
    {
        $sql = "INSERT INTO userlist VALUES (NULL, :fullname, :username, :email, :pass, :age, :image, :role, :is2f, :is2f_secret)";
    ...
    public function updateuser($user, $id) {
        $sql = "UPDATE userlist SET fullname = :fullname, username = :username, email = :email, pass = :pass, age = :age, image = :image, role = :role WHERE id = :id";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
            $query->execute([
    ...
    public function activate2f($id,$secret) {
        $sql = "UPDATE userlist SET is2f=:is2f , is2f_secret=:is2f_secret WHERE id = :id";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
            $query->execute([
    ...
    public function deactivate2f($id) {
        $sql = "UPDATE userlist SET is2f=:is2f , is2f_secret=:is2f_secret WHERE id = :id";
        $db = config::getConnexion();
        try {
            $query = $db->prepare($sql);
